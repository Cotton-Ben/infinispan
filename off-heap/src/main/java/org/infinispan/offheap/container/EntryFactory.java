...
import org.infinispan.offheap.container.entries.InternalCacheEntry;
import org.infinispan.offheap.container.entries.MVCCEntry;

/**
 * A factory for constructing {@link org.infinispan.offheap.container.entries.MVCCEntry} instances for use in the {@link org.infinispan.context.InvocationContext}.
 * Implementations of this interface would typically wrap an internal {@link org.infinispan.offheap.container.entries.CacheEntry}
 * with an {@link org.infinispan.offheap.container.entries.MVCCEntry}, optionally acquiring the necessary locks via the
...
public interface EntryFactory {
   ...
   /**
    * Wraps an entry for reading.  Usually this is just a raw {@link org.infinispan.offheap.container.entries.CacheEntry} but certain combinations of isolation
