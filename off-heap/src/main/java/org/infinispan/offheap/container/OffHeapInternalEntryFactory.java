...
import org.infinispan.offheap.container.entries.OffHeapInternalCacheEntry;
import org.infinispan.offheap.container.versioning.EntryVersion;

/**
 * A factory for {@link org.infinispan.offheap.container.entries.OffHeapInternalCacheEntry} and {@link org.infinispan.offheap.container.entries.OffHeapInternalCacheValue} instances.
 *
...
public interface OffHeapInternalEntryFactory {
    ...
    * @return a new InternalCacheEntry
    */
   OffHeapInternalCacheEntry create(Object key, Object value, Metadata metadata);
    ...
    * @return a new InternalCacheEntry
    */
   OffHeapInternalCacheEntry create(Object key, Object value, Metadata metadata, long lifespan, long maxIdle);
    ...
    * @return a new InternalCacheEntry
    */
   OffHeapInternalCacheEntry create(Object key, Object value, Metadata metadata, long created, long lifespan, long lastUsed, long maxIdle);
   ...
   OffHeapInternalCacheEntry create(Object key, Object value, EntryVersion version, long created, long lifespan, long lastUsed, long maxIdle);
    ...
    * {@link org.infinispan.offheap.container.entries.OffHeapInternalCacheEntry} instance being created, as a different {@link org.infinispan.offheap.container.entries.OffHeapInternalCacheEntry} implementation
    * may be more appropriate to suit the new metadata values.  As such, one should consider the {@link org.infinispan.offheap.container.entries.OffHeapInternalCacheEntry}
    ...
    */
   OffHeapInternalCacheEntry update(OffHeapInternalCacheEntry cacheEntry, Metadata metadata);
